...
const storage = multer.diskStorage({
 ...
 module.exports.UploadAvarta= async (req,res)=>{
  try{
    // if (req.isAuthenticated() && 'CHUNHATRO' == req.user.role)      Check lai
    if ( 2 > 1 )
    { 
    ...
    try{
        ...
        { 
            let{title,content_infor,number_phone,price,acreage,
                ...
                // Google Map
                    newPhongTro.address.Lat_ggmap=Lat_ggmap || 21.0285;
                    newPhongTro.address.Lng_ggmap=Lng_ggmap || 105.8542;    
