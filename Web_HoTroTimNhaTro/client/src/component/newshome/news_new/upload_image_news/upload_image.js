...
//##############___Result Delete Image Infor News (Back End)__##############
    ...
    UploadImageAvatar= async(e)=> {
        ...
        await axios.post("http://localhost:3000/phong-tro/dang-tin-moi/upload_image",formData,config)
            .then((res) => {
                console.log('response: ', res);
                this.setState({
                    result_upload_avatar:res.data.result,
                    filename_avatar:res.data.filename_avatar,
                    URL_avatar:"http://localhost:3000/phong-tro/open_image/nameimage="+res.data.filename_avatar
                });
            }).catch((error) => {
            console.log(error);
        });
    ...
    UploadImageInfor=async (e)=>{
        ...
        await axios.post("http://localhost:3000/phong-tro/dang-tin-moi/up-load_hinh-mo-ta",formDataFilesInfor,config)
            .then((res) => {
                console.log("arrayimagenames: ", res.data)
                this.setState({
    ...
    DeleteImageInfor=async(e,item,index)=>{
        e.preventDefault();
        await axios.post('http://localhost:3000/phong-tro/dang-tin-moi/xoa-anh-mo-ta',{
